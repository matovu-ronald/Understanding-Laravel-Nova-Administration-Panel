    ...
    methods: {
        activateCache: function activateCache() {
            Nova.request().post('/nova-vendor/viewcache').then(function (data) {
                alert('View Cache Successfully Activated');
            });
        }
    }
});
  ...
  return _c(
    ...
    [
      ...
      _c(
        "card",
        {
          staticClass: "bg-gray-100 flex flex-col items-center justify-center",
          staticStyle: { "min-height": "300px" }
        },
        [
          _c(
            "h1",
            { staticClass: "text-black-400 text-4xl text-90 font-medium mb-6" },
            [
              _vm._v(
                "\n            Enable Your Applications View Cache\n        "
              )
            ]
          ),
          _vm._v(" "),
          _c(
            ...
            {
              staticClass:
                "bg-black-200 text-black-600 font-semibold px-8 py-4 rounded-lg shadow-lg",
