...
Nova.booting(function (Vue, router, store) {
    Vue.component('NovaClock', __webpack_require__(2));
});
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("digital-clock", {
            staticClass: "font-bold text-5xl shadow-lg px-8 py-4 rounded-full",
            attrs: {
              blink: _vm.card.blink,
              twelveHour: _vm.card.twelveHour,
              displaySeconds: _vm.card.withSeconds
            }
          })
        ],
        1
